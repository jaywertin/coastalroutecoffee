      ...
      <section className="px-6 py-24 sm:py-32 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div><p className="eyebrow text-[#9b6a2d]">Choose your route</p><h2 className="font-display mt-4 max-w-2xl text-5xl leading-[0.95] tracking-[-0.035em] sm:text-6xl">Three coffees. One better morning.</h2></div>
